...
public class CreateShiftTemplateBlockDtoValidator : AbstractValidator<CreateShiftTemplateBlockDto>
{
    public CreateShiftTemplateBlockDtoValidator()
    {
    ...
    private static bool HaveDifferentTimes(CreateShiftTemplateBlockDto block)
    {
