...
namespace Buy2.Infrastructure.Migrations
{
    ...
    [Migration("20260914212604_AddPerformanceCompositeIndexes")]
    partial class AddPerformanceCompositeIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.PointsAutomationRange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("AutomationSettingId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.PointsAutomationRun", b =>
                {
                    ...
                    b.HasIndex("Status", "Category", "PeriodEnd");
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.PointsAutomationSetting", b =>
                {
                    ...
                    b.ToTable("PointsAutomationSettings");
                });
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.PointsTransaction", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("EvaluationPeriodEnd")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("EvaluationPeriodStart")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.Qualification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.ShiftBlock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.ShiftEntity", b =>
                {
                    ...
                    b.Property<bool>("HasUnqualifiedOverride")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("SiteId", "StartTime");

                    b.HasIndex("IsPublished", "EmployeeId", "StartTime");
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.ShiftTemplateSite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ShiftTemplateId", "SiteId")
                        .IsUnique();

                    b.ToTable("ShiftTemplateSites");
                });
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.AttendanceRecord", b =>
                {
                    ...
                    b.HasOne("Buy2.Domain.Entities.ShiftEntity", "ScheduledShift")
                        .WithMany()
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.Employee", b =>
                {
                    b.HasOne("Buy2.Domain.Entities.Department", null)
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.EmployeeAchievement", b =>
                {
                    b.HasOne("Buy2.Domain.Entities.Badge", "Badge")
                        .WithMany()
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.JobRole", b =>
                {
                    b.HasOne("Buy2.Domain.Entities.Department", "Department")
                        .WithMany("JobRoles")
                        .HasForeignKey("DepartmentId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.PointsAutomationRange", b =>
                {
                    b.HasOne("Buy2.Domain.Entities.PointsAutomationSetting", "AutomationSetting")
                        .WithMany("Ranges")
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.ShiftBlock", b =>
                {
                    ...
                    b.HasOne("Buy2.Domain.Entities.ShiftTemplate", "ShiftTemplate")
                        .WithMany("ShiftBlocks")
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.ShiftTemplate", b =>
                {
                    b.HasOne("Buy2.Domain.Entities.Employee", "LastUpdatedByEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("Buy2.Domain.Entities.ShiftTemplate", b =>
                {
                    b.Navigation("ShiftBlocks");

                    b.Navigation("ShiftTemplateSites");
                });
